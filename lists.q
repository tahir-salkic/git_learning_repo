...
a:`long$1+til 5 /5 element list of longs from 1 to 5
b:`long$6+til 5 /5 element list of longs from 6 to 10
...
twoFloats:(2.o 3.0) /a two element list of floats with the numbers 2 and 3 as its two elements
...
secondEachM:{x 1} /extract the 2nd element from each element in m
